...
impl Rootfs {
    pub fn execute(dir: &str, command: &str) {
    ...
    pub fn disable_service(dir: &str, service: &str) {
        Rootfs::execute(dir, &format!("systemctl disable {}", service));
        Rootfs::execute(dir, &format!("systemctl mask {}", service));
    }
}
...
impl SetupThing for Rootfs {
    ...
    fn build(&self, _options: &crate::Options) -> color_eyre::eyre::Result<(), String> {
        ...
        // Packages
        Rootfs::execute(RD, "dnf --assumeyes update");
